...
function contarPalabrasRepetidas(cadena) {
  ...
  palabras.forEach((palabra) => {
    if (contador[palabra]) {
      contador[palabra]++; // Incrementa el contador si la palabra ya existe
    } else {
      contador[palabra] = 1; // Inicializa el contador si es la primera vez que se encuentra la palabra
    }
  });
...
const recuento = contarPalabrasRepetidas(codigo);
